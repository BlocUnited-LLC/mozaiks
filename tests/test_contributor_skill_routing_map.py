...
def test_control_plane_and_persistence_companion_notes_are_explicit() -> None:
    ...
    assert "Add `appgenerator-change` when generated `database_intent.json`, `config/database_migrations/{migration_id}.json`, or generated module persistence output changes." in persistence_skill