...
def test_runtime_artifact_writers_use_shared_helpers() -> None:
    ...
    workflow_download = _read("factory_app/app/workflows/AgentGenerator/tools/generate_and_download.py")
    workflow_converter = _read("factory_app/app/workflows/AgentGenerator/tools/workflow_converter.py")
