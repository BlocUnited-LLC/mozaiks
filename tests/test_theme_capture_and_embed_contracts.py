...
def test_theme_capture_uses_canonical_context_and_handoffs() -> None:
    context_vars = _read_yaml("mozaiks-platform/app/workflows/ThemeCapture/context_variables.yaml")
    handoffs = _read_yaml("mozaiks-platform/app/workflows/ThemeCapture/handoffs.yaml")
    tools = _read_yaml("mozaiks-platform/app/workflows/ThemeCapture/tools.yaml")
...
def test_theme_capture_preload_collects_parent_theme_evidence() -> None:
    module = _load_module(
        "mozaiks-platform/app/workflows/ThemeCapture/tools/preload_theme_capture_context.py",
...
def test_theme_capture_saver_persists_context_and_emits_preview(monkeypatch) -> None:
    module = _load_module(
        "mozaiks-platform/app/workflows/ThemeCapture/tools/save_captured_theme.py",
...
def test_theme_capture_contract_targets_visual_tokens_not_shell_content() -> None:
    structured_outputs = _read_text("mozaiks-platform/app/workflows/ThemeCapture/structured_outputs.yaml")
    agents = _read_text("mozaiks-platform/app/workflows/ThemeCapture/agents.yaml")
    saver = _read_text("mozaiks-platform/app/workflows/ThemeCapture/tools/save_captured_theme.py")
    preview = _read_text("mozaiks-platform/app/workflows/ThemeCapture/ui/ThemeCapture/components/ThemePreviewCard.js")
