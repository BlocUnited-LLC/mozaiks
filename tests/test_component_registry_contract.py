...
def test_component_registry_quiets_same_component_reregistration() -> None:
    source = (REPO_ROOT / "chat-ui/src/registry/componentRegistry.js").read_text(encoding="utf-8")
...
def test_mozaiks_app_keeps_workflow_initializer_stable() -> None:
    source = (REPO_ROOT / "chat-ui/src/app/MozaiksApp.jsx").read_text(encoding="utf-8")
