                ...
                "code_files": [
                    {
                        "filename": path,
                        "content": (
                            yaml.safe_dump({"schema_version": "mozaiks.app_page.v1", "name": "Notifications", "route": "/notifications", "title": "Notifications", "page_type": "record_list", "layout": "full-width", "sections": [{"id": "header", "primitive": "PageHeader", "config": {"title": "Notifications"}}]})
                            if path == "ui/pages/notifications.yaml"
                            else f"# generated by {task.get('task_id', '')} for {path}"
                        ),
                    }
