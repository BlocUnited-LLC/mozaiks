...
This guide covers the **write path** of the self-hosted entitlement chain for
apps generated by mozaiks. It explains how the `entitlement_dispatch` module
writes subscription assignment records that `ConfiguredEntitlementAdapter`
reads to grant or deny capability access.
