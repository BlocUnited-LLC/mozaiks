...
This is the authoritative reference for the MozaiksAI context variables system. All other context variable documentation is superseded by this document.
