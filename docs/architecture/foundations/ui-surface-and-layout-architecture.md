...
|--------|----------------|--------------------|
| `conversationMode` | `ask`, `workflow` | `chat-ui/src/state/uiSurfaceReducer.js` |
| `layoutMode` | `full`, `split`, `minimized`, `view` | `chat-ui/src/state/uiSurfaceReducer.js` |
| `surfaceMode` | `ASK`, `WORKFLOW`, `VIEW` | `chat-ui/src/state/uiSurfaceReducer.js` |
| `artifact.status` | `inactive`, `active`, `stale` | `chat-ui/src/state/uiSurfaceReducer.js` |
| `workflowStatus` | `idle`, `running`, `completed`, `error` | `chat-ui/src/state/uiSurfaceReducer.js` |
...
Implemented in `chat-ui/src/components/chat/FluidChatLayout.jsx`.
...
Implemented in `chat-ui/src/components/chat/MobileArtifactDrawer.jsx`.
...
Implemented in `chat-ui/src/state/uiSurfaceReducer.js`.
...
All implemented. Files in `chat-ui/src/primitives/`.
...
`ChatUIContext` (at `chat-ui/src/context/ChatUIContext.jsx`) is the single provider. It persists:
...
`ArtifactActionsBar.jsx` (`chat-ui/src/components/actions/ArtifactActionsBar.jsx`) is implemented and wired into `ArtifactPanel`.
...
|------------|--------|--------------------|
| Surface reducer (ask/workflow/view) | Done | `chat-ui/src/state/uiSurfaceReducer.js` |
| Desktop layout widths + view mode | Done | `chat-ui/src/components/chat/FluidChatLayout.jsx` |
| Mobile artifact drawer + fullscreen | Done | `chat-ui/src/components/chat/MobileArtifactDrawer.jsx` |
| `ArtifactPanel` (mobile + desktop + view) | Done | `chat-ui/src/components/chat/ArtifactPanel.jsx` |
| Core primitives (`core.*`) | Done — all 6 | `chat-ui/src/primitives/` |
| `PrimitiveRenderer` dispatch | Done | `chat-ui/src/primitives/PrimitiveRenderer.jsx` |
| `ChatUIContext` shared provider | Done | `chat-ui/src/context/ChatUIContext.jsx` |
| `PersistentChatWidget` | Done | `chat-ui/src/components/chat/PersistentChatWidget.jsx` |
| `useWidgetMode` | Done | `chat-ui/src/hooks/useWidgetMode.jsx` |
| `GlobalChatWidgetWrapper` | Done | `chat-ui/src/widget/GlobalChatWidgetWrapper.jsx` |
| Artifact action buttons (frontend) | Done | `chat-ui/src/components/actions/ArtifactActionsBar.jsx` |
...
- `docs/architecture/foundations/event-taxonomy.md`
