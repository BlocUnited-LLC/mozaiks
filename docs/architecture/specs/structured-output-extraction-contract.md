...
- [workflow-authoring-contracts.md](../foundations/workflow-authoring-contracts.md)
- [auto_tool_handler.py](../../../mozaiksai/core/events/auto_tool_handler.py)
- [structured.py](../../../mozaiksai/core/workflow/outputs/structured.py)
