...
**Depends on:** [Orchestration and Decomposition](../../architecture/orchestration-and-decomposition.md), [Workflow Architecture](../../architecture/workflows/workflow-architecture.md), [Orchestration Control Loops](../../architecture/workflows/orchestration-control-loops.md), [MFJ Strict Resume Contract](mfj-strict-resume-contract.md)
