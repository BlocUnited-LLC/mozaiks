...
- `app_type_selector -> brownfield_path_selector -> brownfield_repo_input -> ExistingAppDiscovery -> enhancement path selection -> ValueEngine -> scoped existing-app build sequence`
