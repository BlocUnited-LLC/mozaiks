...
_DEFAULT_DB_NAME = "MozaiksAI"


def get_mongo_db_name() -> str:
    """Return the configured MongoDB database name.

    Resolution: MONGO_DB_NAME env var > default ("MozaiksAI").
    """
    return (os.getenv("MONGO_DB_NAME") or _DEFAULT_DB_NAME).strip()
...
def get_app_id_from_chat_or_context(chat_id: Optional[str] = None) -> Optional[str]:
    ...
    try:
        ...
        raw_app_id = getattr(conn, "app_id", None)
