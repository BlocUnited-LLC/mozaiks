...
Usage:
    from mozaiksai.runtime.auth.websocket_auth import authenticate_websocket, WebSocketUser
...
from mozaiksai.runtime.auth.config import get_auth_config
from mozaiksai.runtime.auth.jwt_validator import get_jwt_validator, TokenClaims, AuthError
...
class WebSocketUser:
    ...
    def validate_app_id(self, path_app_id: str) -> bool:
        ...
        if not self.mozaiks_app_id:
            return True  # No app_id claim — token not scoped to a specific app
