...
from mozaiksai.runtime.config import get_mongo_db_name
from mozaiksai.runtime.data.persistence.persistence_manager import PersistenceManager
...
DEFAULT_THEME: Dict[str, Any] = {
    # Schema reference — the frontend's brand.json is the source of truth
    # for visual identity. This dict provides a known-good example for tests
    # and a merge base for partial update payloads.
    "fonts": {
        "body": {
            "family": "Rajdhani",
...
class ThemeManager:
    ...
    async def _get_collection(self):
        ...
        async with self._init_lock:
            ...
            db = self._persistence.client[get_mongo_db_name()]
