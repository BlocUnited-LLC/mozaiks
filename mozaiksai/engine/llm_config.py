...
try:  # pragma: no cover - defensive import
    from mozaiksai.runtime.config import get_secret, get_mongo_client  # type: ignore
...
async def get_llm_config(
    *,
    ...
    Returns a tuple (wrapper_placeholder, llm_config). The first element
    is always None (kept for API stability); the second is the dict passed to
    ConversableAgent.
    """
