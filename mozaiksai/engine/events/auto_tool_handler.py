...
from mozaiksai.engine.outputs.structured import get_structured_outputs_for_workflow
...
from mozaiksai.engine.context.adapter import create_context_container
...
class AutoToolEventHandler:
    ...
    async def _load_bindings_for_workflow(self, workflow_name: str) -> Dict[str, AutoToolBinding]:
        ...
        wf_config = workflow_manager.get_config(workflow_name) or {}
        entries = wf_config.get("tools") or []
