...
def load_pack_graph(workflow_name: str) -> Optional[Dict[str, Any]]:
    ...
    schema, which normalizes journeys and v3 mid_flight_journeys.
    ...
    try:
        from mozaiksai.kernel.pack.schema import parse_pack_graph
        parse_pack_graph(data)  # validate structure; logs warnings internally
