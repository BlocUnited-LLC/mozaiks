...
from mozaiksai.adapters.ag2.observability.token_logger import get_realtime_token_logger
...
def _ensure_otel_initialized() -> None:
    ...
    try:
        from mozaiksai.adapters.ag2.observability.tracing import initialize_otel_tracing
