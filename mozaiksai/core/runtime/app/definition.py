...
class WorkflowRef(BaseModel):
    ...
    name: str
    path: str | None = None  # defaults to the active workflow root selected for the host/session


class ModuleRef(BaseModel):
    """Reference to a discovered module."""
    name: str
    path: str | None = None  # defaults to active app root modules/{name}/


class PageRef(BaseModel):
    """Reference to a discovered UI page."""
    name: str
    path: str | None = None  # defaults to active app root ui/pages/{name}/
