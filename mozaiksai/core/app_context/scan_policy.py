...
DEFAULT_CONTEXT_GRAPH_PRIORITY_RULES: tuple[ScanPriorityRule, ...] = (
    ...
    ScanPriorityRule("app_generator/contracts/", 6, "app_generator_contracts"),
    ScanPriorityRule("app_generator/capability_packs/", 7, "app_generator_capability_packs"),
    ScanPriorityRule("app_generator/", 8, "app_generator"),
