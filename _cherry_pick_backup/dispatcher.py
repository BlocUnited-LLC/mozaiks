...
from mozaiksai.engine.events.auto_tool_handler import AutoToolEventHandler
from mozaiksai.kernel.usage_ingest import get_usage_ingest_client
...
from mozaiksai.engine.events.serialization import serialize_event_content
...
try:  # workflow config (optional in some minimal test contexts)
    from mozaiksai.kernel.workflow_manager import workflow_manager  # type: ignore
...
class UnifiedEventDispatcher:
    ...
    def build_outbound_event_envelope(
        ...
        *,
        ...
        # ─── Dict-with-kind path (AG2 runtime events) ────────────────────
        ...
        ns_map = {
            ...
            'stream_chunk': 'chat.stream_chunk', 'stream_end': 'chat.stream_end',
            'custom_event': 'chat.custom_event',
        }
