  ...
  switch (adapter.kind) {
    case 'llm':
      return (
        <>
          ...
          <DetailRow
            label="API Key"
            value={adapter.api_key_set ? adapter.api_key_masked : 'not set'}
            mono
          />
        </>
      )
    ...
    case 'database':
      return (
        <DetailRow
          label="Connection"
          value={adapter.configured ? adapter.uri_masked : 'MONGO_URI not set'}
          mono
        />
      )
    ...
    case 'sandbox':
      return (
        <DetailRow
          label="API Key"
          value={adapter.api_key_set ? adapter.api_key_masked : 'E2B_API_KEY not set'}
          mono
        />
      )
    ...
    case 'backend':
      return (
        <>
          ...
          <DetailRow
            label="Internal Key"
            value={adapter.internal_key_set ? adapter.internal_key_masked : 'not set'}
            mono
          />
        </>
      )
  ...
  return (
    <AdminWorkspaceLayout>
      <div className="flex flex-col gap-6">
        ...
        <SurfaceCard title="Adapters" eyebrow="Builder" accent>
