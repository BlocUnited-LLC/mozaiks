...
description: Audit or plan Codex MCP usage for this project. Use when deciding whether a tool should be local, project-scoped, or user-scoped, when reviewing .mcp.json plans, or when adding shared integrations like GitHub, Sentry, databases, or docs sources.
